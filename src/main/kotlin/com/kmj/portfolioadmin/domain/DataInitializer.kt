package com.kmj.portfolioadmin.domain

import com.kmj.portfolioadmin.domain.constant.SkillType
import com.kmj.portfolioadmin.domain.entity.*
import com.kmj.portfolioadmin.domain.repository.*
        ...
        project2.addDetails(
            mutableListOf(
                ...
                ProjectDetail(content = "Github Repository",
                    url = "https://github.com/infomuscle",
                    isActive = true)
            )
        )
